...
void main() {
  ...
  testWidgets('ChallengesDashboardScreen shows empty state', (tester) async {
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          ...
          activeChallengesProvider('p1').overrideWith((ref) => []),
          profileProgressProvider('p1').overrideWith((ref) => []),
        ],
        child: const MaterialApp(
          home: ChallengesDashboardScreen(),
        ),
      ),
    );
  ...
  testWidgets('ChallengesDashboardScreen shows active challenges', (tester) async {
    final session = ActiveProfileSession(
      profileId: 'p1',
      pinVerified: true,
      startedAt: DateTime.now(),
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          familyRepositoryProvider.overrideWithValue(mockRepo),
          activeChallengesProvider('p1').overrideWith((ref) => [challenge]),
